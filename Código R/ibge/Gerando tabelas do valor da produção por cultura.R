...
#Valor da produção por cultura em mil reais
  ...
  ano16 <- "https://raw.githubusercontent.com/igorfdeoliv/dissertacao/main/dataset/ibge/valor%20da%20producao/2018%20tabela5457.csv"
  ano17 <- "https://raw.githubusercontent.com/igorfdeoliv/dissertacao/main/dataset/ibge/valor%20da%20producao/2019%20tabela5457.csv"
...
#Reorganizando as colunas
  ...
  v2003$Dendê..cacho.de.coco. <- as.numeric(v2003$Dendê..cacho.de.coco.)
  v2003$Girassol..em.grão. <- as.numeric(v2003$Girassol..em.grão.)
  v2003$Mamona..baga. <- as.numeric(v2003$Mamona..baga.)
  v2003$Soja..em.grão. <- as.numeric(v2003$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2004$Dendê..cacho.de.coco. <- as.numeric(v2004$Dendê..cacho.de.coco.)
  v2004$Girassol..em.grão. <- as.numeric(v2004$Girassol..em.grão.)
  v2004$Mamona..baga. <- as.numeric(v2004$Mamona..baga.)
  v2004$Soja..em.grão. <- as.numeric(v2004$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2005$Dendê..cacho.de.coco. <- as.numeric(v2005$Dendê..cacho.de.coco.)
  v2005$Girassol..em.grão. <- as.numeric(v2005$Girassol..em.grão.)
  v2005$Mamona..baga. <- as.numeric(v2005$Mamona..baga.)
  v2005$Soja..em.grão. <- as.numeric(v2005$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2006$Dendê..cacho.de.coco. <- as.numeric(v2006$Dendê..cacho.de.coco.)
  v2006$Girassol..em.grão. <- as.numeric(v2006$Girassol..em.grão.)
  v2006$Mamona..baga. <- as.numeric(v2006$Mamona..baga.)
  v2006$Soja..em.grão. <- as.numeric(v2006$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2007$Dendê..cacho.de.coco. <- as.numeric(v2007$Dendê..cacho.de.coco.)
  v2007$Girassol..em.grão. <- as.numeric(v2007$Girassol..em.grão.)
  v2007$Mamona..baga. <- as.numeric(v2007$Mamona..baga.)
  v2007$Soja..em.grão. <- as.numeric(v2007$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2008$Dendê..cacho.de.coco. <- as.numeric(v2008$Dendê..cacho.de.coco.)
  v2008$Girassol..em.grão. <- as.numeric(v2008$Girassol..em.grão.)
  v2008$Mamona..baga. <- as.numeric(v2008$Mamona..baga.)
  v2008$Soja..em.grão. <- as.numeric(v2008$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2009$Dendê..cacho.de.coco. <- as.numeric(v2009$Dendê..cacho.de.coco.)
  v2009$Girassol..em.grão. <- as.numeric(v2009$Girassol..em.grão.)
  v2009$Mamona..baga. <- as.numeric(v2009$Mamona..baga.)
  v2009$Soja..em.grão. <- as.numeric(v2009$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2010$Dendê..cacho.de.coco. <- as.numeric(v2010$Dendê..cacho.de.coco.)
  v2010$Girassol..em.grão. <- as.numeric(v2010$Girassol..em.grão.)
  v2010$Mamona..baga. <- as.numeric(v2010$Mamona..baga.)
  v2010$Soja..em.grão. <- as.numeric(v2010$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2011$Dendê..cacho.de.coco. <- as.numeric(v2011$Dendê..cacho.de.coco.)
  v2011$Girassol..em.grão. <- as.numeric(v2011$Girassol..em.grão.)
  v2011$Mamona..baga. <- as.numeric(v2011$Mamona..baga.)
  v2011$Soja..em.grão. <- as.numeric(v2011$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2012$Dendê..cacho.de.coco. <- as.numeric(v2012$Dendê..cacho.de.coco.)
  v2012$Girassol..em.grão. <- as.numeric(v2012$Girassol..em.grão.)
  v2012$Mamona..baga. <- as.numeric(v2012$Mamona..baga.)
  v2012$Soja..em.grão. <- as.numeric(v2012$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2013$Dendê..cacho.de.coco. <- as.numeric(v2013$Dendê..cacho.de.coco.)
  v2013$Girassol..em.grão. <- as.numeric(v2013$Girassol..em.grão.)
  v2013$Mamona..baga. <- as.numeric(v2013$Mamona..baga.)
  v2013$Soja..em.grão. <- as.numeric(v2013$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2014$Dendê..cacho.de.coco. <- as.numeric(v2014$Dendê..cacho.de.coco.)
  v2014$Girassol..em.grão. <- as.numeric(v2014$Girassol..em.grão.)
  v2014$Mamona..baga. <- as.numeric(v2014$Mamona..baga.)
  v2014$Soja..em.grão. <- as.numeric(v2014$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2015$Dendê..cacho.de.coco. <- as.numeric(v2015$Dendê..cacho.de.coco.)
  v2015$Girassol..em.grão. <- as.numeric(v2015$Girassol..em.grão.)
  v2015$Mamona..baga. <- as.numeric(v2015$Mamona..baga.)
  v2015$Soja..em.grão. <- as.numeric(v2015$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2016$Dendê..cacho.de.coco. <- as.numeric(v2016$Dendê..cacho.de.coco.)
  v2016$Girassol..em.grão. <- as.numeric(v2016$Girassol..em.grão.)
  v2016$Mamona..baga. <- as.numeric(v2016$Mamona..baga.)
  v2016$Soja..em.grão. <- as.numeric(v2016$Soja..em.grão.)
...
#Reorganizando as colunas
  ...
  v2017$Dendê..cacho.de.coco. <- as.numeric(v2017$Dendê..cacho.de.coco.)
  v2017$Girassol..em.grão. <- as.numeric(v2017$Girassol..em.grão.)
  v2017$Mamona..baga. <- as.numeric(v2017$Mamona..baga.)
  v2017$Soja..em.grão. <- as.numeric(v2017$Soja..em.grão.)
...
#Importando tabela
  ...
  v2018 <- read.csv(ano16, header=T, sep=";",dec = ".", skip = 4,nrows = 5563,
                    na.strings = c("-","..."), encoding = "UTF-8")
...
#Reorganizando as colunas
  ...
  v2018 <- v2018[,c(7,1,2,3,4,5,6)]
  
#Exportando tabela
  
  setwd("E:/igorf/Documents/GitHub/dissertacao/dataset/base/anos/2018")
  
  write.table(v2018,file='valor_producao.csv',sep=";",dec=".",na="0",quote=TRUE, row.names=FALSE)
...
#Importando tabela
  ...
  v2019 <- read.csv(ano17, header=T, sep=";",dec = ".", skip = 4,nrows = 5563,
                    na.strings = c("-","..."), encoding = "UTF-8")
...
#Reorganizando as colunas
  ...
  v2019 <- v2019[,c(7,1,2,3,4,5,6)]
  
#Exportando tabela
  
  setwd("E:/igorf/Documents/GitHub/dissertacao/dataset/base/anos/2019")
  
  write.table(v2019,file='valor_producao.csv',sep=";",dec=".",na="0",quote=TRUE, row.names=FALSE)
